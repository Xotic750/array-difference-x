 ...
 */
"use strict";var filter=_dereq_("array-filter-x"),some=_dereq_("array-some-x"),slice=_dereq_("array-slice-x"),arrayincludes=_dereq_("array-includes-x"),isNil=_dereq_("is-nil-x");module.exports=function difference(array){if(isNil(array))return[];var excludes=slice(arguments,1);return filter(array,function(value){return!1===some(excludes,function(exclude){return!1===isNil(exclude)&&arrayincludes(exclude,value)})})}},{"array-filter-x":2,"array-includes-x":3,"array-slice-x":4,"array-some-x":5,"is-nil-x":23}],2:[function(_dereq_,module,exports){/**
