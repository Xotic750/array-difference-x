 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),filter=_dereq_("array-filter-x"),some=_dereq_("array-some-x"),slice=_dereq_("array-slice-x"),arrayincludes=_dereq_("array-includes-x"),isNil=_dereq_("is-nil-x");module.exports=function difference(array){var object=toObject(array),excludes=slice(arguments,1);return filter(object,function(value){return!1===some(excludes,function(exclude){return!1===isNil(exclude)&&arrayincludes(exclude,value)})})}},{"array-filter-x":2,"array-includes-x":3,"array-slice-x":4,"array-some-x":5,"is-nil-x":23,"to-object-x":41}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x"),some=_dereq_("array-some-x");module.exports=function filter(array,callBack){var object=toObject(array);assertIsFunction(callBack);var result=[],args=[object,function _wrapped(item,idx,obj){callBack.call(this,item,idx,obj)&&(result[result.length]=item)}];return arguments.length>2&&(args[2]=arguments[2]),some.apply(void 0,args),result}},{"array-some-x":5,"assert-is-function-x":6,"to-object-x":41}],3:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var $includes,toObject=_dereq_("to-object-x"),nativeIncludes=Array.prototype.includes;if(nativeIncludes){var arr={1:"a",2:NaN,3:-0,length:5};try{nativeIncludes.call(arr,void 0,-1)&&nativeIncludes.call(arr,NaN)&&nativeIncludes.call("abc","c")&&($includes=function includes(array,searchElement){var object=toObject(array),args=[searchElement];return arguments.length>2&&(args[1]=arguments[2]),nativeIncludes.apply(object,args)})}catch(ignore){}}if(!1===Boolean($includes)){var isString=_dereq_("is-string"),isUndefined=_dereq_("validate.io-undefined"),toLength=_dereq_("to-length-x"),sameValueZero=_dereq_("same-value-zero-x"),findIndex=_dereq_("find-index-x"),splitString=!1===_dereq_("has-boxed-string-x"),indexOf=_dereq_("index-of-x"),calcFromIndex=_dereq_("calculate-from-index-x"),findIdxFrom=function findIndexFrom(object,searchElement,fromIndex){for(var fIdx=fromIndex,length=toLength(object.length);fIdx<length;){if(sameValueZero(object[fIdx],searchElement))return fIdx;fIdx+=1}return-1};$includes=function includes(array,searchElement){var object=toObject(array),iterable=splitString&&isString(object)?object.split(""):object,length=toLength(iterable.length);if(length<1)return-1;if(isUndefined(searchElement)){var fromIndex=calcFromIndex(iterable,arguments[2]);return fromIndex>=length?-1:(fromIndex<0&&(fromIndex=0),fromIndex>0?findIdxFrom(iterable,searchElement,fromIndex)>-1:findIndex(iterable,function(element){return sameValueZero(searchElement,element)})>-1)}return indexOf(iterable,searchElement,arguments[2],"samevaluezero")>-1}}module.exports=$includes},{"calculate-from-index-x":7,"find-index-x":9,"has-boxed-string-x":11,"index-of-x":14,"is-string":25,"same-value-zero-x":38,"to-length-x":40,"to-object-x":41,"validate.io-undefined":47}],4:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":18,"is-primitive":24,"safe-to-string-x":37}],7:[function(_dereq_,module,exports){/**
 ...
 * @module find-index-x
 */
"use strict";var findIdx,pFindIndex=Array.prototype.findIndex;if(pFindIndex&&0===[,1].findIndex(function(item,idx){return 0===idx}))findIdx=function findIndex(array,callback){var args=[callback];return arguments.length>2&&(args[1]=arguments[2]),pFindIndex.apply(array,args)};else{var toLength=_dereq_("to-length-x"),toObject=_dereq_("to-object-x"),isString=_dereq_("is-string"),assertIsFunction=_dereq_("assert-is-function-x"),splitString=!1===_dereq_("has-boxed-string-x");findIdx=function findIndex(array,callback){var object=toObject(array);assertIsFunction(callback);var iterable=splitString&&isString(object)?object.split(""):object,length=toLength(iterable.length);if(length<1)return-1;var thisArg;arguments.length>2&&(thisArg=arguments[2]);for(var index=0;index<length;){if(callback.call(thisArg,iterable[index],index,object))return index;index+=1}return-1}}module.exports=findIdx},{"assert-is-function-x":6,"has-boxed-string-x":11,"is-string":25,"to-length-x":40,"to-object-x":41}],10:[function(_dereq_,module,exports){var hasOwn=Object.prototype.hasOwnProperty,toString=Object.prototype.toString;module.exports=function forEach(obj,fn,ctx){if("[object Function]"!==toString.call(fn))throw new TypeError("iterator must be a function");var l=obj.length;if(l===+l)for(var i=0;i<l;i++)fn.call(ctx,obj[i],i,obj);else for(var k in obj)hasOwn.call(obj,k)&&fn.call(ctx,obj[k],k,obj)}},{}],11:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var boxedString=Object("a");module.exports="a"===boxedString[0]&&0 in boxedString},{}],12:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";module.exports=_dereq_("has-symbol-support-x")&&"symbol"==typeof Symbol.toStringTag},{"has-symbol-support-x":12}],14:[function(_dereq_,module,exports){/**
 ...
 * @module index-of-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),isString=_dereq_("is-string"),toObject=_dereq_("to-object-x"),toLength=_dereq_("to-length-x"),sameValueZero=_dereq_("same-value-zero-x"),sameValue=_dereq_("object-is"),findIndex=_dereq_("find-index-x"),calcFromIndex=_dereq_("calculate-from-index-x"),splitString=!1===_dereq_("has-boxed-string-x"),pIndexOf=Array.prototype.indexOf;"function"==typeof pIndexOf&&-1===[0,1].indexOf(1,2)||(pIndexOf=function indexOf(searchElement){var length=toLength(this.length);if(length<1)return-1;for(var i=arguments[1];i<length;){if(i in this&&this[i]===searchElement)return i;i+=1}return-1});var findIdxFrom=function findIndexFrom(array,searchElement,fromIndex,extendFn){for(var fIdx=fromIndex,length=toLength(array.length);fIdx<length;){if(fIdx in array&&extendFn(array[fIdx],searchElement))return fIdx;fIdx+=1}return-1};module.exports=function indexOf(array,searchElement){var object=toObject(array),iterable=splitString&&isString(object)?object.split(""):object,length=toLength(iterable.length);if(length<1)return-1;var extendFn,argLength=arguments.length,extend=argLength>2&&argLength>3?arguments[3]:arguments[2];isString(extend)&&("samevalue"===(extend=extend.toLowerCase())?extendFn=sameValue:"samevaluezero"===extend&&(extendFn=sameValueZero));var fromIndex=0;if(extendFn&&(0===searchElement||$isNaN(searchElement))){if(argLength>3){if((fromIndex=calcFromIndex(iterable,arguments[2]))>=length)return-1;fromIndex<0&&(fromIndex=0)}return fromIndex>0?findIdxFrom(iterable,searchElement,fromIndex,extendFn):findIndex(iterable,function(element,index){return index in iterable&&extendFn(searchElement,element)})}if(argLength>3||argLength>2&&!1===Boolean(extendFn)){if((fromIndex=calcFromIndex(iterable,arguments[2]))>=length)return-1;fromIndex<0&&(fromIndex=0)}return pIndexOf.call(iterable,searchElement,fromIndex)}},{"calculate-from-index-x":7,"find-index-x":9,"has-boxed-string-x":11,"is-nan":20,"is-string":25,"object-is":32,"same-value-zero-x":38,"to-length-x":40,"to-object-x":41}],15:[function(_dereq_,module,exports){"use strict";var toStr=Object.prototype.toString,isStandardArguments=function isArguments(value){return"[object Arguments]"===toStr.call(value)},isLegacyArguments=function isArguments(value){return!!isStandardArguments(value)||null!==value&&"object"==typeof value&&"number"==typeof value.length&&value.length>=0&&"[object Array]"!==toStr.call(value)&&"[object Function]"===toStr.call(value.callee)},supportsStandardArguments=function(){return isStandardArguments(arguments)}();isStandardArguments.isLegacyArguments=isLegacyArguments,module.exports=supportsStandardArguments?isStandardArguments:isLegacyArguments},{}],16:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x"),isFunction=_dereq_("is-function-x"),isLength=_dereq_("lodash.islength");module.exports=function isArrayLike(value){return!1===isNil(value)&&!1===isFunction(value,!0)&&isLength(value.length)}},{"is-function-x":18,"is-nil-x":23,"lodash.islength":27}],17:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":25}],36:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":23}],37:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isSymbol=_dereq_("is-symbol"),pToString=_dereq_("has-symbol-support-x")&&Symbol.prototype.toString;module.exports=function safeToString(value){return pToString&&isSymbol(value)?pToString.call(value):String(value)}},{"has-symbol-support-x":12,"is-symbol":26}],38:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var is=_dereq_("object-is");module.exports=function sameValueZero(x,y){return x===y||is(x,y)}},{"object-is":32}],39:[function(_dereq_,module,exports){/**
 ...
 * @module to-integer-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),$isFinite=_dereq_("is-finite-x"),$sign=_dereq_("math-sign-x");module.exports=function ToInteger(value){var number=Number(value);return $isNaN(number)?0:0===number||!1===$isFinite(number)?number:$sign(number)*Math.floor(Math.abs(number))}},{"is-finite-x":17,"is-nan":20,"math-sign-x":29}],40:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function ToLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":30,"to-integer-x":39}],41:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var $requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function ToObject(value){return Object($requireObjectCoercible(value))}},{"require-object-coercible-x":36}],42:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":28,"validate.io-undefined":47}],43:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":26}],44:[function(_dereq_,module,exports){/**
