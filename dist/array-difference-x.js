...
if (nativeSome) {
  ...
  var array_some_x_esm_res = dist_attempt_x_esm.call([1, 2], nativeSome, function (item) {
  ...
  if (array_some_x_esm_isWorking) {
    ...
    array_some_x_esm_res = dist_attempt_x_esm.call(array_some_x_esm_castObject('abc'), nativeSome, function (item, index) {
      array_some_x_esm_newArrowCheck(this, array_some_x_esm_this);
  ...
  if (array_some_x_esm_isWorking) {
    ...
    array_some_x_esm_res = dist_attempt_x_esm.call(function getArgs() {
      /* eslint-disable-next-line prefer-rest-params */
      return arguments;
  ...
  if (array_some_x_esm_isWorking) {
    array_some_x_esm_spy = 0;
    array_some_x_esm_res = dist_attempt_x_esm.call({
      0: 1,
      1: 2,
      3: 3,
      4: 4,
  ...
  if (array_some_x_esm_isWorking) {
    ...
    if (array_some_x_esm_doc) {
      ...
      array_some_x_esm_res = dist_attempt_x_esm.call(array_some_x_esm_fragment.childNodes, nativeSome, function (item) {
        array_some_x_esm_newArrowCheck(this, array_some_x_esm_this);
  ...
  if (array_some_x_esm_isWorking) {
    ...
    if (array_some_x_esm_isStrict) {
      array_some_x_esm_spy = null;
      array_some_x_esm_res = dist_attempt_x_esm.call([1], nativeSome, function () {
        array_some_x_esm_newArrowCheck(this, array_some_x_esm_this);
  ...
  if (array_some_x_esm_isWorking) {
    ...
    array_some_x_esm_res = dist_attempt_x_esm(Function('nativeSome', 'spy', array_some_x_esm_fn), nativeSome, array_some_x_esm_spy);
...
var array_like_slice_x_esm_slice = function slice(arrayLike, start, end) {
  var iterable = split_if_boxed_bug_x_dist_split_if_boxed_bug_x_esm(to_object_x_dist_to_object_x_esm(arrayLike));
  var length = to_length_x_dist_to_length_x_esm(iterable.length);
  var k = setRelative(to_integer_x_dist_to_integer_x_esm(start), length);
  var relativeEnd = typeof end === 'undefined' ? length : to_integer_x_dist_to_integer_x_esm(end);
...
var calculate_from_index_x_esm_calcFromIndex = function calcFromIndex(array, fromIndex) {
  ...
  return index >= 0 ? index : calculate_from_index_x_esm_getMax(0, calculate_from_index_x_node_modules_to_length_x_dist_to_length_x_esm(object.length) + index);
};
